export const NAV_LINKS = [
  { label: "How it works", to: "/", hash: "prediction-learning" as const },
  { label: "Github", href: "https://github.com/samvedmamillapalli/Migrate.ai" },
  { label: "Our Journey", to: "/our-journey" as const },
];

export const GITHUB_URL = "https://github.com/samvedmamillapalli/Migrate.ai";

export const PIPELINE_STEPS = [
  { title: "Policy Checks", description: "Validate controls and guardrails.", icon: "shield" },
  { title: "Memory Retrieval", description: "Recall similar migrations.", icon: "database" },
  { title: "AI Prediction", description: "Forecast risks and paths.", icon: "blocks" },
  { title: "Human Approval", description: "Review with context.", icon: "check" },
  { title: "Shadow Execution", description: "Run safely in parallel.", icon: "branch" },
  { title: "Grade and Learn", description: "Improve every run.", icon: "blocks" },
] as const;
...
export const JOURNAL_ENTRIES = [
  {
    ...
    excerpt: "Every verified migration becomes experience that improves the next prediction.",
