...
class WorkspaceMemberResponse(BaseModel):
    ...
    workspace_id: uuid.UUID
    user_identity: str
    # No profile-data source (no users table) — display_name/email/avatar_url
    # stay null rather than being fabricated. The frontend already falls
    # back to user_identity when display_name is absent.
